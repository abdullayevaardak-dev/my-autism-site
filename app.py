...
LANG_DATA = {
    ...
    'Қазақша': {
        ...
        'logo_secs': ["1-блок: Дыбыстың айтылуы және артикуляция", "2-блок: Сөздің буындық құрылымы", "3-блок: Фोनेматикалық үрдістер", "4-блок: Лексика-грамматикалық құрылым және байланыстырып сөйлеу", "5-блок: Сөйлеу қарқыны мен ырғағы"],
        'logo_q': [
...
# --- ПАНЕЛЬ АДМИНА ---
    ...
    # 1. Вывод логинов и паролей специалистов
...
# --- РАБОЧАЯ ЗОНА СПЕЦИАЛИСТОВ ---
    ...
    with tabs[0]:
        ...
        # --- КАНБИНЕТ УЧИТЕЛЯ (РАС и СДВГ структурированы по вашему запросу) ---
        if st.session_state.role == "Учитель":
            st.subheader(T['teach_title'])
            
            # Раздел РАС выводится один раз
            ...
            # Раздел СДВГ выводится один раз
        ...
        # Кнопка сохранения данных в Облако Supabase
