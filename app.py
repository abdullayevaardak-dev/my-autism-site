...
# --- ПАНЕЛЬ АДМИНА ---
    ...
    try:
        ...
        # --- НОВЫЙ БЛОК: УДАЛЕНИЕ СПЕЦИАЛИСТОВ ---
    ...
    try:
        ...
        if all_kids:
            ...
            # --- НОВЫЙ БЛОК: УДАЛЕНИЕ ОШИБОЧНЫХ АНКЕТ ---
